        ...
        readTags.forEach((tag) => {
            ...
            switch (tag.wordLen) {
                case 1 /* snap7.WordLen.S7WLBit */:
                    if (tag.format === 'Bit') {
                        tag.values = [...(_a = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _a === void 0 ? void 0 : _a.data];
                        break;
                    }
                ...
                case 2 /* snap7.WordLen.S7WLByte */:
                    if (tag.format === 'Byte_As_BitArray') {
                        tag.values = (0, buffer_to_data_1.bufferByteToBitArray)((_b = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _b === void 0 ? void 0 : _b.data);
                        break;
                    }
                    if (tag.format === 'Byte_As_Int') {
                        tag.values = (0, buffer_to_data_1.bufferByteToInt)((_c = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _c === void 0 ? void 0 : _c.data);
                        break;
                    }
                    if (tag.format === 'Byte_As_Uint') {
                        tag.values = (0, buffer_to_data_1.bufferByteToUInt)((_d = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _d === void 0 ? void 0 : _d.data);
                        break;
                    }
                    throw new errors_1.BadRequestError(`Tag No: ${tag.id} cannot be formatted as ${tag.format}`);
                case 4 /* snap7.WordLen.S7WLWord */:
                    if (tag.format === 'Word_As_BitArray') {
                        tag.values = (0, buffer_to_data_1.bufferWordToBitArray)((_e = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _e === void 0 ? void 0 : _e.data);
                        break;
                    }
                    if (tag.format === 'Word_As_Int') {
                        tag.values = (0, buffer_to_data_1.bufferWordToInt)((_f = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _f === void 0 ? void 0 : _f.data);
                        break;
                    }
                    if (tag.format === 'Word_As_Uint') {
                        tag.values = (0, buffer_to_data_1.bufferWordToUInt)((_g = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _g === void 0 ? void 0 : _g.data);
                        break;
                    }
                    throw new errors_1.BadRequestError(`Tag No: ${tag.id} cannot be formatted as ${tag.format}`);
                case 6 /* snap7.WordLen.S7WLDWord */:
                    if (tag.format === 'Dword_As_BitArray') {
                        tag.values = (0, buffer_to_data_1.bufferDWordToBitArray)((_h = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _h === void 0 ? void 0 : _h.data);
                        break;
                    }
                    if (tag.format === 'Dword_As_Int') {
                        tag.values = (0, buffer_to_data_1.bufferDwordToInt)((_j = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _j === void 0 ? void 0 : _j.data);
                        break;
                    }
                    if (tag.format === 'Dword_As_Uint') {
                        tag.values = (0, buffer_to_data_1.bufferDwordToUInt)((_k = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _k === void 0 ? void 0 : _k.data);
                        break;
                    }
                    throw new errors_1.BadRequestError(`Tag No: ${tag.id} cannot be formatted as ${tag.format}`);
                case 8 /* snap7.WordLen.S7WLReal */:
                    if (tag.format === 'Real') {
                        tag.values = (0, buffer_to_data_1.bufferRealToFloat)((_l = resp.find((resp) => resp.id === tag.id && resp.address.deviceId === tag.address.deviceId)) === null || _l === void 0 ? void 0 : _l.data);
                        break;
                    }
                    throw new errors_1.BadRequestError(`Tag No: ${tag.id} cannot be formatted as ${tag.format}`);
                default:
